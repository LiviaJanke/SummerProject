# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 18:01:38 2021
...
def calc_beta_with_exceptions(year):
    x=0
    co24year=[]
    beta=[]
    avco2=[]
...
def forcing_CO2_with_beta(alpha,beta):
    F=alpha*np.log(beta)
    return F
...
def yearly_temp_increase(number_years):
    ...
    for i in range (0,number_years):
        dF_CO2=forcing_CO2_with_beta(5.3,Beta[i])
        dF_N2O=0
        dF_methane=0
...
#print(data.head())
data2=np.loadtxt('C:/Users/Admin/Documents/SummerProject/Data/co2_mm_mlo.txt') #loading CO2 against years data
print(data2)
...
year1,temp1,temp2=sp.loadtxt('C:/Users/Admin/Documents/SummerProject/Data/graph.txt',skiprows=5,unpack=True)
...
print(len(time))
#%% calculating beta
co2_data=np.loadtxt("C:/Users/Admin/Documents/SummerProject/Data/co2_mm_mlo.txt")
temp_data=np.loadtxt("C:/Users/Admin/Documents/SummerProject/Data/graph.txt", skiprows=5)
co2=co2_data[:,3]
beta=[]
x=0
avco2=[]
...
Co2_data = np.loadtxt('C:/Users/Admin/Documents/SummerProject/monthly_flask_co2_mlo.csv', skiprows = 59, delimiter = ',', unpack = 0)
...
#print(beta)
#print(len(beta))
Beta=calc_beta_with_exceptions(2020)
